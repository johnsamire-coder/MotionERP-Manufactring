...
type PageKey =
  ...
  | 'sales'
  | 'reports'
  | 'settings' | 'planning' | 'technical' | 'material' | 'production_ops' | 'quality' | 'costing' | 'delivery' | 'accounting';
