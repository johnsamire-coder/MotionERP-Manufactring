...
type PageKey =
  ...
  | 'sales'
  | 'reports'
  | 'settings' | 'planning' | 'technical' | 'material' | 'production_ops' | 'quality' | 'costing' | 'delivery' | 'accounting' | 'hr' | 'auth' | 'expenses';
...
const NAV_ITEMS: ReadonlyArray<{ key: PageKey; icon: IconName }> = [
  ...
  { key: 'sales', icon: 'sales' },
    ...
    { key: 'auth', icon: 'building' },
    { key: 'expenses', icon: 'chart' },
...
const PAGE_META: Record<PageKey, { title: string; description: string; icon: IconName }> = {
  ...
  auth: { title: 'navigation.auth', description: 'pages.auth.description', icon: 'building' },
  expenses: { title: 'navigation.expenses', description: 'pages.expenses.description', icon: 'chart' },
