...
export function StockEntryPage(): JSX.Element {
  ...
  if (loading)
    return <p style={{ padding: 40, textAlign: 'center' }}>Loading Stock Entry Data...</p>;
          ...
          >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                ...
                >
                  ...
                  <option value="transfer">
                    Material Transfer (تحويل بين المخازن / نقل بضاعة)
                  </option>
                </select>
              </div>
            ...
            >
              {(purpose === 'issue' || purpose === 'transfer') && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  <select
                    value={sourceWId}
                    onChange={(e) => setSourceWId(e.target.value)}
                    style={{ ...inputStyle, width: '100%' }}
                    required
                  >
                    {warehouses.map((wh) => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <textarea
                ...
                placeholder="e.g. Scrap replacement, monthly stock count adjustment..."
        ...
        <div className="placeholder-table">
          ...
          {movements.length === 0 && (
            <p style={{ padding: '20px 0', textAlign: 'center', color: '#94a3b8' }}>
              No stock movements registered yet.
            </p>
          )}
          ...
          {movements.slice(0, 50).map((mov) => (
            <div className="placeholder-table__row" key={mov.id}>
              ...
              <span>
                <b>{parseFloat(mov.quantity).toFixed(2)}</b>
              </span>
