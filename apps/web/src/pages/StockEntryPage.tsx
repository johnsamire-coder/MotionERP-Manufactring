...
export const StockEntryPage: React.FC = () => {
  const entries = [
    {
      id: 'STE-2026-0811',
      type: 'صرف خامات للتشغيل',
      from: 'مخزن الخامات الرئيسي',
      to: 'ورشة تشكيل الصاج (WIP)',
      item: 'صاج ستانلس 304 (702 كجم)',
      ref: 'WO-2026-08112',
      date: '2026-10-10',
    },
    {
      id: 'STE-2026-0812',
      type: 'استلام منتج تام',
      from: 'خط التجميع النهائي',
      to: 'مخزن المنتج التام',
      item: '10 أسرة عناية مركزة كهربائية',
      ref: 'WO-2026-08150',
      date: '2026-10-11',
    },
    {
      id: 'STE-2026-0815',
      type: 'تحويل بين المخازن',
      from: 'مخزن الخامات الرئيسي',
      to: 'مخزن الإكسسوارات الطبية',
      item: '20 طقم بساتم هيدروليكية',
      ref: 'TRF-2026-012',
      date: '2026-10-12',
    },
  ];
    ...
    <div className="p-6 space-y-6 bg-slate-50 min-h-screen text-slate-800" dir="rtl">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">
              أذون وحركات التحويل المخزني (Stock Entries)
            </h1>
            <p className="text-sm text-slate-500">
              إصدار أذون صرف التشغيل استلام المنتج التام والتحويلات بين المخازن
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-slate-200 bg-slate-50 font-bold text-slate-900">
          سجل حركات وأذون المخازن المرحلة
        </div>
