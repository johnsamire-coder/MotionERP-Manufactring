 ...
 */
export const workflowDefinition = workflowSchema.table(
  'workflow_definition',
  {
...
export const workflowState = workflowSchema.table(
  'workflow_state',
  {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const workflowTransition = workflowSchema.table(
  'workflow_transition',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    workflowId: uuid('workflow_id')
...
export const workflowInstance = workflowSchema.table(
  'workflow_instance',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    workflowId: uuid('workflow_id')
...
export const workflowHistory = workflowSchema.table(
  'workflow_history',
  {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const workflowTransitionTask = workflowSchema.table(
  'transition_task',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    workflowId: uuid('workflow_id')
...
export const workflowTaskRun = workflowSchema.table(
  'task_run',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    taskId: uuid('task_id')
      .notNull()
      .references(() => workflowTransitionTask.id, { onDelete: 'cascade' }),
    instanceId: uuid('instance_id')
      .notNull()
      .references(() => workflowInstance.id, { onDelete: 'cascade' }),
