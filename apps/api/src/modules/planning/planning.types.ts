...
export interface SalesForecastRecord {
  ...
  fromDate: string;
  toDate: string;
  basedOn: SalesForecastBasedOn;
  forecastPeriodicity: SalesForecastPeriodicity;
  status: SalesForecastStatus;
  lines: SalesForecastLineRecord[];
}
...
export interface SupplierLeadTimeInput {
  supplierName: string;
  leadTimeDays: string;
}
...
export interface CreateItemLeadTimeInput {
  itemId: string;
  orgNodeId: string;
  manufacturingTimeHours?: string;
  isManufacturingLeadTime?: boolean;
  manufacturingBufferDays?: string;
  purchaseTimeDays?: string;
  isPurchaseLeadTime?: boolean;
  purchaseBufferDays?: string;
...
export interface CreateMpsInput {
  ...
  fromDate: string;
  toDate: string;
  totalForecastQuantity?: string;
  plannedQuantity?: string;
  scheduleLines: MpsScheduleLineInput[];
}
