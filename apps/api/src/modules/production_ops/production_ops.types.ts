...
export interface ProductionStepRecord {
  ...
  overproductionPercentage: string | null;
...
export interface CreateProductionStepInput {
  ...
  forQuantity?: string;
  allowOverproduction?: boolean;
  overproductionPercentage?: string;
...
export interface WorkOrderRecord {
  ...
  considerScrapItems: boolean;
  materialConsumptionPercentage: string;
  materialTransferMode: MaterialTransferMode;
...
export interface WorkstationTypeRecord {
  id: string;
  code: string;
  name: string;
  status: WorkstationTypeStatus;
}
export interface CreateWorkstationTypeInput {
  code: string;
  name: string;
}
