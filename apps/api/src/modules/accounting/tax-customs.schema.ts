...
// ============================================================
import { pgSchema, uuid, text, numeric, date, integer, timestamp } from 'drizzle-orm/pg-core';
...
export const customsDeclaration = taxSchema.table('customs_declaration', {
  ...
  clearanceExpenses: numeric('clearance_expenses', { precision: 18, scale: 4 })
    .default('0')
    .notNull(), // مصاريف تخليص
