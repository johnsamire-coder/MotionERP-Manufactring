...
export const uom = catalogSchema.table(
  'uom',
  {
...
export const uomTranslation = catalogSchema.table(
  'uom_translation',
  {
    uomId: uuid('uom_id')
      .notNull()
...
export const itemCategory = catalogSchema.table(
  'item_category',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    code: text('code').notNull(),
...
export const itemCategoryTranslation = catalogSchema.table(
...
export const item = catalogSchema.table(
  'item',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    code: text('code').notNull(),
  ...
  (t) => [
    ...
    check(
      'item_shelf_life_non_negative',
      sql`${t.shelfLifeInDays} is null or ${t.shelfLifeInDays} >= 0`,
    ),
...
export const itemTranslation = catalogSchema.table(
  'item_translation',
  {
    itemId: uuid('item_id')
      .notNull()
...
export const itemPrice = catalogSchema.table(
  'item_price',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    itemId: uuid('item_id')
...
export const uomConversion = catalogSchema.table(
  'uom_conversion',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    itemId: uuid('item_id')
