...
export interface CollectionRecord {
  id: string; jobOrderReference: string; collectionNumber: string; collectionDate: string;
...
export interface RetentionRecord {
  id: string; jobOrderReference: string; retentionNumber: string; originalAmount: string;
