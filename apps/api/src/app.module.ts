...
@Module({
  imports: [
    ...
    QualityModule, CostModule, DeliveryModule, AccountingModule, FinanceModule, HrModule, AuthModule, WorkflowModule, SupportModule, ProjectsModule, AssetsModule, PrintingModule,
  ],
})
