...
- **الاختبارات (بعد المرحلة التالتة):** API 363، وweb 5، وshared 7، وe2e 18. كلهم ناجحين.
...
- **"التكلفة الفعلية" في كارت أمر الشغل** بتتسجل يدوي من شاشة التكاليف، ومش بتتملي تلقائيًا من صرف الخامات. الربط التلقائي ممكن، بس محتاج قرار: هل الصرف يتسجل تكلفة فعلية على أمر الشغل تلقائيًا؟
